  ...
  return (
    <div className="space-y-6">
      <Card className="gradient-card">
        <CardHeader>
          <CardTitle className="text-foreground">Actualizar Estadísticas</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-sm text-foreground">Partidos Jugados</label>
              <Input
                type="number"
            ...
            <div>
              <label className="text-sm text-foreground">Partidos Ganados</label>
              <Input
                type="number"
                value={newStats.won}
            ...
            <div>
              <label className="text-sm text-foreground">Partidos Perdidos</label>
              <Input
                type="number"
                value={newStats.lost}
            ...
            <div>
              <label className="text-sm text-foreground">Sets a Favor</label>
              <Input
                type="number"
            ...
            <div>
              <label className="text-sm text-foreground">Sets en Contra</label>
              <Input
                type="number"
            ...
            <div>
              <label className="text-sm text-foreground">Puntos</label>
              <Input
                type="number"
      ...
      <Card className="gradient-card">
        ...
        <CardContent className="space-y-4">
          <div>
            <label className="text-sm text-foreground">Filtrar por Liga</label>
          ...
          <div>
            <label className="text-sm text-foreground">Filtrar por Equipo</label>
      ...
      <Card className="gradient-card">
        <CardHeader>
          <CardTitle className="text-foreground">Estadísticas Actuales</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            {filteredStats.map((stat) => {
              ...
              return (
                <div key={stat.id} className="p-4 bg-muted rounded-lg">
                  <h3 className="font-semibold mb-2 text-foreground">{getTeamName(stat.team_id)}</h3>
